...
- [ ] 1. Set up project structure and shared types
  - [ ] 1.1 Create directory structure and initialize packages
  ...
  - [ ] 1.2 Define shared type interfaces
...
- [ ] 2. Implement Terraform networking and security foundation
  - [ ] 2.1 Create Terraform provider configuration and variables
  ...
  - [ ] 2.2 Create VPC and networking resources
  ...
  - [ ] 2.3 Create security groups with least-privilege rules
...
- [ ] 3. Implement Terraform data layer and IAM
  - [ ] 3.1 Create IAM roles and instance profiles
  ...
  - [ ] 3.2 Create Secrets Manager for RDS credentials
  ...
  - [ ] 3.3 Create RDS PostgreSQL instance
...
- [ ] 4. Checkpoint — Verify Terraform foundation
  - Ensure `terraform validate` passes for all files created so far, ask the user if questions arise.

- [ ] 5. Implement Terraform compute and load balancing
  - [ ] 5.1 Create ALB with target groups and routing rules
  ...
  - [ ] 5.2 Create Catalog Service EC2 instance
  ...
  - [ ] 5.3 Create Orders Service EC2 instance with dedicated EBS volume
  ...
  - [ ] 5.4 Create S3 static website hosting for frontend
...
- [ ] 6. Implement Terraform observability stack
  - [ ] 6.1 Create SNS topic for alarm notifications
  ...
  - [ ] 6.2 Create CloudWatch alarms and dashboard
...
- [ ] 7. Checkpoint — Verify complete Terraform configuration
  - Run `terraform validate` and `terraform fmt` on all Terraform files, ensure no errors. Ask the user if questions arise.

- [ ] 8. Implement Catalog Service
  - [ ] 8.1 Create database connection module
  ...
  - [ ] 8.2 Implement Catalog Service route handlers
  ...
  - [ ] 8.3 Create Catalog Service Express app entry point
  ...
  - [ ]* 8.4 Write property tests for Catalog Service
  ...
  - [ ]* 8.5 Write unit tests for Catalog Service routes
...
- [ ] 9. Implement Orders Service core checkout logic
  - [ ] 9.1 Create database connection module for Orders Service
    - Create `app/orders-service/src/db.ts` with PostgreSQL connection pool using `pg`
    - Read connection parameters from environment variables
    - Implement connection retry with exponential backoff
    - _Requirements: 13.2_

  - [ ] 9.2 Implement order log writer (EBS dependency)
  ...
  - [ ] 9.3 Implement checkout route handler
  ...
  - [ ]* 9.4 Write property tests for checkout validation
  ...
  - [ ]* 9.5 Write property tests for invalid checkout rejection
  ...
  - [ ]* 9.6 Write unit tests for Orders Service checkout
...
- [ ] 10. Implement fault injection mechanism
  - [ ] 10.1 Create fault injection shell scripts
  ...
  - [ ] 10.2 Implement fault injection TypeScript module
  ...
  - [ ]* 10.5 Write unit tests for fault injection and reset
...
- [ ] 11. Implement health check system
  - [ ] 11.1 Implement Orders Service health check
  ...
  - [ ]* 11.4 Write property test for health check accuracy
  ...
  - [ ]* 11.5 Write property test for health check cleanup
  ...
  - [ ]* 11.6 Write unit tests for health check
...
- [ ] 13. Implement database schema and seed data
  - [ ] 13.1 Create database initialization SQL
  ...
  - [ ]* 13.3 Write property test for database constraints
...
- [ ] 14. Implement frontend UI
  - [ ] 14.1 Create frontend project with Vite
  ...
  - [ ] 14.2 Implement API client module
  ...
  - [ ] 14.3 Implement frontend main application logic
...
- [ ] 15. Wire integration and error handling
  - [ ] 15.1 Implement error handling middleware for Orders Service
  ...
  - [ ] 15.2 Implement error handling middleware for Catalog Service
    - Add Express error handling middleware for DB connection errors → HTTP 503 with `DB_CONNECTION_ERROR`
    - Log errors with context
    - _Requirements: 13.2, 13.4_

  - [ ] 15.3 Wire EC2 user data scripts for service deployment
  ...
  - [ ]* 15.4 Write property test for fault isolation
  ...
  - [ ]* 15.5 Write property test for fault impact on Orders Service
  ...
  - [ ]* 15.6 Write property test for data integrity across fault lifecycle
  ...
  - [ ]* 15.7 Write unit tests for error handling middleware

...
nohup fio --name=ebs-stress --ioengine=libaio --rw=randwrite --bs=4k --direct=1 --numjobs=30 --iodepth=64 --directory="${MOUNT_PATH}" --size=2G --time_based --runtime=3600 </dev/null >/dev/null 2>&1 &
